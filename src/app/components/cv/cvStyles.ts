...
export const styles = StyleSheet.create({
  ...
  jobRole: { fontSize: 10, fontFamily: 'Helvetica-BoldOblique', color: '#444', marginBottom: 5 },
  period: { fontSize: 9, color: '#666666' },
  projectTitle: { fontSize: 9, fontFamily: 'Helvetica-Bold', marginBottom: 1 },
  projectOutcome: { fontSize: 9, color: '#444444', marginLeft: 8, marginBottom: 5 },
  jobBlock: { marginTop: 2, marginBottom: 10 },
  // Education
  institution: { fontSize: 11, fontFamily: 'Helvetica-Bold' },
  degree: { fontSize: 10, fontFamily: 'Helvetica-BoldOblique', color: '#333333', marginBottom: 2 },
  ...
  eduBlock: { marginTop: 3, marginBottom: 10 },
  // Skills
  skillRow: { flexDirection: 'row', marginBottom: 7 },
